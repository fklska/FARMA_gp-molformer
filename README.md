...
У всех молекул достаточно низкая синтетическая сложность ($SA <= 0.4 $) и высокая drug-likeness ($QED >= 0.75$, кроме одной $0.6$)
...
Работа осталось за малым, завершить drug discovery провести клинические испытания и апрувнуть в продакшн) 
